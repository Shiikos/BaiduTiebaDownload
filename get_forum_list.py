...
if __name__ == '__main__':
    ...
    get_forum_list("http://tieba.baidu.com/f?ie=utf-8&kw=XXX")
    browser.service.process.send_signal(signal.SIGTERM)
    browser.quit()

# browser = webdriver.PhantomJS()
# str2 = 'http://tieba.baidu.com/f?kw=XXX&ie=utf-8&pn=50&pagelets=frs-list%2Fpagelet%2Fthread&pagelets_stamp=1472009237919'
